    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-zinc-950 border border-white/10 text-white max-w-lg rounded-3xl p-0 overflow-hidden" showCloseButton={false}>
        ...
        <div className="p-8 space-y-6 relative">
          ...
          {accessToken && (
            <>
              {(!tool.category && !['figma', 'canva', 'notion', 'chatgpt', 'hugging face', 'github', 'sentry'].includes(provider.toLowerCase()) || tool.category?.toLowerCase() === 'dev' || tool.category?.toLowerCase() === 'development') && (
              ...
              {(tool.category?.toLowerCase() === 'design' || tool.category?.toLowerCase() === 'ai' || ['figma', 'canva', 'notion', 'chatgpt', 'hugging face', 'github', 'sentry'].includes(provider.toLowerCase())) && (
