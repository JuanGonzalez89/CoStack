...
export function CheckoutView({ toolSlug }: CheckoutViewProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500 pb-10">
      <div className="flex flex-col gap-2">
        <h2 className="text-3xl font-extrabold text-foreground tracking-tight">Finalizar Compra</h2>
        <p className="text-muted-foreground">Estás a un paso de obtener tu licencia a una fracción del costo.</p>
      </div>
            ...
            <div className="pt-10">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex justify-between items-center text-sm">
                  <span className="text-muted-foreground capitalize">{toolSlug} (Licencia Premium)</span>
              ...
              <div className="border-t border-border pt-4 mb-6 flex justify-between items-end">
                ...
                <div className="text-right">
                  <span className="text-3xl font-black text-foreground block">$5.00</span>
                </div>
              </div>
              ...
              <Button
                ...
                className="w-full rounded-xl py-6 font-bold shadow-sm transition-all duration-200 bg-cyan-500 hover:bg-cyan-400 text-white flex gap-2 items-center justify-center hover:shadow-[0_0_15px_rgba(6,182,212,0.4)] active:scale-[0.98]"
              >
                {isProcessing ? (
                  <>
